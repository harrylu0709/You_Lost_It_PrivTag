...
//   // {
//   //   USB_FS.pGPIOx = VBUS_FS_GPIO_Port;
//   //   USB_FS.GPIO_PinConfig.GPIO_PinNumber = VBUS_FS_Pin;
//   //   USB_FS.GPIO_PinConfig.GPIO_PinMode = GPIO_MODE_IN;
...
//   //   USB_FS.GPIO_PinConfig.GPIO_PinAltFunMode = 10;
//   //   USB_FS.GPIO_PinConfig.GPIO_PinOPType = GPIO_OP_TYPE_PP;
//   //   USB_FS.GPIO_PinConfig.GPIO_PinPuPdControl = GPIO_NO_PUPD;
...
//     GPIO_InitStruct.Alternate = (uint8_t)(0xA);
...
void HAL_PCD_MspInit(PCD_HandleTypeDef* pcdHandle)
{
  ...
  /* USER CODE END USB_OTG_FS_MspInit 0 */
    ...
    PA12     ------> USB_OTG_FS_DP
    */
    GPIO_InitStruct.Pin = (1<<9);
    GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(VBUS_FS_GPIO_Port, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = (1<<10)|(1<<11)|(1<<12);
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
