...
extern void HAL_NVIC_SetPriorityGrouping(uint32_t PriorityGroup);
/**
  * @}
  */
...
void init_systick_timer(uint32_t tick_hz)
{
    ...
    uint32_t count_value = (SystemCoreClock/tick_hz)-1;// if 1 second, then tick_hz = 1, if 1 millisecond, then tick_hz = 1000
