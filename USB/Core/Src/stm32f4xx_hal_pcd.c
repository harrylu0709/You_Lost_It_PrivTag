...
HAL_StatusTypeDef HAL_PCD_Init(PCD_HandleTypeDef *hpcd)
{
  ...
  //asert_param(IS_PCD_ALL_INSTANCE(hpcd->Instance));
...
void HAL_GPIO_Init(GPIO_RegDef_t  *GPIOx, GPIO_InitTypeDef *GPIO_Init)
{
  uint32_t position;
  ...
  /* Check the parameters */
  // //asert_param(IS_GPIO_ALL_INSTANCE(GPIOx));
  // //asert_param(IS_GPIO_PIN(GPIO_Init->Pin));
  // //asert_param(IS_GPIO_MODE(GPIO_Init->Mode));
  ...
  for(position = 0U; position < 16; position++)
  {
    ...
    if(iocurrent == ioposition)
    {
          ...
          (GPIO_Init->Mode & GPIO_MODE) == MODE_AF)
      {
        ...
        //asert_param(IS_GPIO_SPEED(GPIO_Init->Speed));
      ...
      {
        /* Check the parameters */
        //asert_param(IS_GPIO_PULL(GPIO_Init->Pull));
      ...
      if((GPIO_Init->Mode & GPIO_MODE) == MODE_AF)
      {
        ...
        //asert_param(IS_GPIO_AF(GPIO_Init->Alternate));
